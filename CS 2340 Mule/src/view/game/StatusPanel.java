...
public class StatusPanel extends JPanel {
	...
	JLabel p1StatusLabel, p1Name, p1Money, p1Energy, p1Smithore, p1Food,
			p1Crystite;
	JLabel p2StatusLabel, p2Name, p2Money, p2Energy, p2Smithore, p2Food,
			p2Crystite;
	JLabel p3StatusLabel, p3Name, p3Money, p3Energy, p3Smithore, p3Food,
			p3Crystite;
	JLabel p4StatusLabel, p4Name, p4Money, p4Energy, p4Smithore, p4Food,
			p4Crystite;
	...
	/**
	 * METHOD that updates the StatusPanel's JLabels for each player's
	 * information
	 */
	public void updateStatusPanel(String[][] info) {

		// player 1:
		p1StatusLabel.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/statusBorder-"
						+ info[0][1].substring(0, 1).toUpperCase()
						+ info[0][1].substring(1) + ".png")));
		...
		// player 2:
		p2StatusLabel.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/statusBorder-"
						+ info[1][1].substring(0, 1).toUpperCase()
						+ info[1][1].substring(1) + ".png")));
		...
		// player 3:
		if (info[2][0] != null) {
			p3StatusLabel.setIcon(new ImageIcon(StatusPanel.class
					.getResource("/sprites/statusBorder-"
							+ info[2][1].substring(0, 1).toUpperCase()
							+ info[2][1].substring(1) + ".png")));
		...
		// player 4:
		if (info[3][0] != null) {
			p4StatusLabel.setIcon(new ImageIcon(StatusPanel.class
					.getResource("/sprites/statusBorder-"
							+ info[3][1].substring(0, 1).toUpperCase()
							+ info[3][1].substring(1) + ".png")));
	...
	private void initialize(int numPlayers) {
		...
		statusLabelBackground.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/Status-Panel.png")));
	...
	private void initializeP1Labels() {
		...
		p1Energy.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/energy.png")));
		...
		p1Smithore.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/smithore.png")));
		...
		p1Food.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/food.png")));
		...
		p1Crystite.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/christite.png")));
	...
	private void initializeP2Labels() {
		...
		p2Energy = new JLabel("");
		p2Energy.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/energy.png")));
		...
		p2Smithore.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/smithore.png")));
		...
		p2Food = new JLabel("");
		p2Food.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/food.png")));
		...
		p2Crystite.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/christite.png")));
	...
	private void initializeP3Labels() {
		...
		p3Energy = new JLabel("");
		p3Energy.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/energy.png")));
		...
		p3Smithore.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/smithore.png")));
		...
		p3Food = new JLabel("");
		p3Food.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/food.png")));
		...
		p3Crystite.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/christite.png")));
	...
	private void initializeP4Labels() {
		...
		p4Energy = new JLabel("");
		p4Energy.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/energy.png")));
		...
		p4Smithore.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/smithore.png")));
		...
		p4Food = new JLabel("");
		p4Food.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/food.png")));
		...
		p4Crystite.setIcon(new ImageIcon(StatusPanel.class
				.getResource("/sprites/christite.png")));
